        ...
        for(Zone z: tempZones)
        {
            ...
            for(CollidableGroup cG: z.collidableGroups)
            {
                ...
                for(Pixel pix: cG.pixels)
                {
                    ...
                    pixels[i] = pix;
                    locationVA[i*3] = infoMapT[pix.row][pix.col].xOriginal;
                    locationVA[i*3 + 1] = infoMapT[pix.row][pix.col].yOriginal;
                    locationVA[i*3 + 2] = infoMapT[pix.row][pix.col].depth;
                ...
                cG.xOriginal = centerPX;
                cG.yOriginal = centerPY;
                cG.halfSquareLength = furthestDist + Constants.PIXEL_SIZE*.7f;

                centerZX += cG.xOriginal;
                centerZY += cG.yOriginal;
            }
            ...
            z.xOriginal = centerZX;
            z.yOriginal = centerZY;
            z.halfSquareLength = furthestDist + Constants.CELL_SIZE;
        }
